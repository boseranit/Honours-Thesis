...
\begin{proof}
	...
	$G$-equivariant. Next, the image of Weil homomorphism   
	$(S(\g)^*\otimes \Omega(P\times V))^G \to \Omega(P\times V)_{hor}$ 
	will be closed because it
	commutes with the differential operators. Finally, the result
	after taking the horizontal projection is also closed. 

	% guillemin p157
	It remains to check that integration along the fiber of
	$\tau:=\operatorname{Car}_{\omega}(p_2^*U)\in\Omega(E)$ equals 
	$1\in\Omega^0(M)$. 
