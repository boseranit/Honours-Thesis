...
% no separation between list items
\setlist{nosep} % default approx 1ex
% bold proofs
\let\oldproofname=\proofname
\renewcommand{\proofname}{\rm\textit{\textbf{\oldproofname}}}
...
\input{introduction}
\input{chapter_equivariant}
\input{chapter_mq}
\input{chapter_local}
\input{chapter_donaldson}
\input{chapter_aj}
%\input{supersymmetry}
